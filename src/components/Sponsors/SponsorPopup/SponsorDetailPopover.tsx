...
const SponsorDetailPopover = (props: SponsorDetailPropsType) => {
  const { isClose, company_name, image_url, description, website_link } = props;
  return (
    <motion.div
        ...
        <div className="grid grid-cols-12 gap-y-4 md:gap-y-0 md:gap-x-5  lg:gap-x-6 mt-4 md:mt-5">
          <div className="col-span-12 md:col-span-4  ">
            <Image
              ...
              width={165}
              height={60}
              className="w-full h-auto  object-cover max-w-[150px] md:min-w-[150px] border border-light-grey-1  rounded-2xl py-7 md:py-10  lg:py-14 px-5"
            />
          </div>
